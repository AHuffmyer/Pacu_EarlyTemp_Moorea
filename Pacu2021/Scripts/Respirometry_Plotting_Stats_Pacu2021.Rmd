...
Rmodel1<-aov(R.nmol.org.min~Temperature, data=PRdata, subset=c(R.nmol.org.min<0)) 
summary(Rmodel1)
```

Check for effects of day.  
```{r}
Rmodel1b<-aov(R.nmol.org.min~Temperature*Date, subset=c(R.nmol.org.min<0), data=PRdata) 
summary(Rmodel1b)
```
...
```{r, results=TRUE, warning=FALSE, message=FALSE}
PRmodel1<-aov(ratio~Temperature, data=PRdata, subset=c(R.nmol.org.min<0)) 
summary(PRmodel1)
```
...
```{r, results=TRUE, warning=FALSE, message=FALSE}
PRmodel1b<-aov(ratio~Temperature*Date, data=PRdata, subset=c(R.nmol.org.min<0)) 
summary(PRmodel1b)
```
