...
plot(blank_data$Plate, blank_data$R.umol.min, ylab="umol O2 min-1",, xlab="Plate Number") #blanks during dark phase
plot(blank_data$Temperature, blank_data$R.umol.min, ylab="umol O2 min-1",xlab="Temperature Level") #blanks during dark phase
