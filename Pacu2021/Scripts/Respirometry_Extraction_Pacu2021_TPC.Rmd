...
#par(mfrow=c(2,2))
plot(oxygen.bio2$Plate, oxygen.bio2$R.nmol.org.min , ylab="nmol O2 larva-1 min-1",xlab="Plate Number") #blanks during dark phase
plot(oxygen.bio2$Temperature, oxygen.bio2$R.nmol.org.min , ylab="nmol O2 larva-1 min-1",xlab="Temperature") #blanks during dark phase
```
