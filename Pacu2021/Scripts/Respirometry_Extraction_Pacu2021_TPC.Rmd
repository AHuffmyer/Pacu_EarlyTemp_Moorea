...
#replace NAs with mean with positive blank values removed 
blank_data <-blank_data %>%
  mutate(R.blank.umol.min = ifelse(is.na(R.blank.umol.min), meanblank.rem, R.blank.umol.min))

blank_data <-blank_data %>%
  group_by(Run) %>%
  summarise(mean.R.blank.umol.min= mean(R.blank.umol.min))
