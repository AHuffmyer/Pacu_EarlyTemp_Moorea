...
gene_list_up_sig.GO <- GO.slim %>%
  ...
  arrange(., ontology, term.x, over_represented_pvalue)
...
GOenrich_27vs34_up_BP.plot <-  ggplot(gene_list_up_sig.GO_plot, aes(x = ontology, y = term.x)) + 
...
write.csv(gene_list_down_sig.GO , file = "Pacu2021/Output/GoSeq/goseq_27vs34_up.csv")
