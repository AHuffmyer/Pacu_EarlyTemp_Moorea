...
# **Generate list of GO terms for GO_MWU analysis**  
...
url="https://raw.githubusercontent.com/JillAshey/FunctionalAnnotation/main/final_Annotations/Pacuta_GOterms_20220121.csv?token=GHSAT0AAAAAABHMRPF6SEFXUTG27A4B6HNEYTJTENA"
go_terms<-read.csv(url(url))
head(go_terms)
dim(go_terms)

url="https://raw.githubusercontent.com/JillAshey/FunctionalAnnotation/main/final_Annotations/Pacuta_annot_20220121.csv?token=GHSAT0AAAAAABHMRPF64KUW3T6426B5IDDCYTJTHDA"
...
```{r}
write.table(go_mwu_terms, "Pacu2021/Output/GOMWU/go_terms.tab", sep="\t", row.names = F)
```